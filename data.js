const SYFUNG_LINKS = [
    ...
    { id: "perplexity", title: "Perplexity", url: "https://www.perplexity.ai", category: "IA - RECHERCHE", description: "Moteur de recherche IA." },
    { id: "manus", title: "Manus", url: "https://manus.im/app", category: "IA - RECHERCHE", description: "Outil IA." },
    { id: "copilot", title: "Copilot", url: "https://copilot.microsoft.com", category: "IA - RECHERCHE", description: "Assistant IA par Microsoft." },
    { id: "hackerai", title: "Hacker AI", url: "https://hackerai.co/", category: "IA - RECHERCHE", description: "IA pour la sécurité et le code." },
    { id: "metaai", title: "Meta AI", url: "https://www.meta.ai", category: "IA - RECHERCHE", description: "Assistant IA par Meta." },
    { id: "notebooklm", title: "NotebookLM", url: "https://notebooklm.google.com", category: "IA - RECHERCHE", description: "Assistant de recherche par Google." },
    { id: "mammouth", title: "Mammouth AI", url: "https://mammouth.ai", category: "IA - RECHERCHE", description: "Accès unifié à GPT, Claude, Gemini et d'autres modèles IA en un seul endroit.", icon: "https://mammouth.ai/favicon.ico" },
    { id: "geministorybook", title: "Gemini Storybook", url: "https://gemini.google/overview/storybook/", category: "IA - RECHERCHE", description: "Explorer les cas d'usage et la vision de Gemini." },
    { id: "geminibusiness", title: "Gemini Business", url: "https://auth.business.gemini.google/login?continueUrl=https://business.gemini.google/?referrer%3Dhttps://www.google.com/&wiffid=CAoSJDBlZjUzZTkxLWFlYTktNDQwNi04MWMwLWUxZmFiYTRlZmVlNw", category: "IA - RECHERCHE", description: "Gemini pour les entreprises et Google Workspace.", icon: "https://upload.wikimedia.org/wikipedia/commons/8/8a/Google_Gemini_logo.svg" },
    { id: "arenaai", title: "Arena AI", url: "https://arena.ai/", category: "IA - RECHERCHE", description: "Plateforme d'intelligence artificielle." },
    { id: "chatzai", title: "Chat Z.ai", url: "https://chat.z.ai/", category: "IA - RECHERCHE", description: "Assistant de recherche et d'IA." },
    { id: "midjourney", title: "Midjourney", url: "https://www.midjourney.com", category: "IA - IMAGES", description: "Génération d'images par IA." },
    { id: "leonardo", title: "Leonardo AI", url: "https://leonardo.ai", category: "IA - IMAGES", description: "Création d'images et assets." },
    { id: "v0", title: "v0 by Vercel", url: "https://v0.dev", category: "IA - IMAGES", description: "Génération d'interfaces UI." },
    { id: "veniceai", title: "Venice AI", url: "https://venice.ai", category: "IA - IMAGES", description: "Génération et IA." },
    { id: "edgegallery", title: "Edge Gallery", url: "https://edgegallery.com", category: "IA - IMAGES", description: "Outils et galerie IA." },
    { id: "suno", title: "Suno", url: "https://suno.com", category: "IA - AUDIO VIDEO", description: "Génération de musique par IA." },
    { id: "runway", title: "Runway", url: "https://runwayml.com", category: "IA - AUDIO VIDEO", description: "Création vidéo par IA." },
    { id: "cursor", title: "Cursor", url: "https://cursor.com", category: "DEV - ASSISTANTS", description: "Éditeur de code IA." },
    { id: "codex", title: "Codex", url: "https://chatgpt.com/fr-FR/codex/", category: "DEV - ASSISTANTS", description: "Génération de code par OpenAI." },
    { id: "claudecode", title: "Claude Code", url: "https://docs.anthropic.com/en/docs/agents-and-tools/claude-code/overview", category: "DEV - ASSISTANTS", description: "Agent de code par Anthropic." },
    { id: "codeium", title: "Codeium", url: "https://codeium.com", category: "DEV - ASSISTANTS", description: "Assistant de code IA gratuit." },
    { id: "tabnine", title: "Tabnine", url: "https://www.tabnine.com", category: "DEV - ASSISTANTS", description: "Assistant de complétion IA." },
    { id: "aider", title: "Aider", url: "https://aider.chat", category: "DEV - ASSISTANTS", description: "IA Pair Programming dans le terminal.", icon: "https://aider.chat/assets/icons/favicon-32x32.png" },
    { id: "aistudio", title: "AI Studio", url: "https://aistudio.google.com/apps", category: "DEV - ASSISTANTS", description: "Plateforme Google pour créer et tester des apps IA avec Gemini.", icon: "https://www.gstatic.com/aistudio/ai_studio_favicon_32x32.png" },
    { id: "supermaven", title: "Supermaven", url: "https://supermaven.com", category: "DEV - ASSISTANTS", description: "Plugin de complétion de code IA ultra-rapide avec une latence ultra-faible." },
    { id: "boltai", title: "Bolt AI", url: "https://boltai.com", category: "DEV - ASSISTANTS", description: "Assistant IA natif pour macOS." },
    { id: "replit", title: "Replit", url: "https://replit.com", category: "DEV - ASSISTANTS", description: "Environnement de développement cloud collaboratif." },
    { id: "bolt", title: "Bolt.new", url: "https://bolt.new", category: "DEV - GENERATEURS", description: "Générateur d'applications web full-stack." },
    { id: "lovable", title: "Lovable", url: "https://lovable.dev", category: "DEV - GENERATEURS", description: "Création d'interfaces UI complètes." },
    { id: "emergent", title: "Emergent.sh", url: "https://app.emergent.sh/", category: "DEV - GENERATEURS", description: "Génère des applications complètes à partir d'une simple description en langage naturel.", icon: "https://app.emergent.sh/favicon.ico" },
    { id: "appinvento", title: "Appinvento", url: "https://www.appinvento.com/", category: "DEV - GENERATEURS", description: "Outil de création d'applications no-code avec accès complet au code source." },
    { id: "dhiwise", title: "DhiWise", url: "https://www.dhiwise.com/", category: "DEV - GENERATEURS", description: "Convertit les maquettes Figma en applications dynamiques Flutter et React." },
    { id: "karbonsites", title: "Karbon Sites", url: "https://karbonsites.com/", category: "DEV - GENERATEURS", description: "Outil de création de sites web basé sur l'IA qui génère du code frontend." },
    { id: "base44", title: "Base44", url: "https://base44.com/", category: "DEV - GENERATEURS", description: "Créateur d'applications et sites web no-code propulsé par l'IA." },
    { id: "rocketnew", title: "Rocket.new", url: "https://www.rocket.new/", category: "DEV - GENERATEURS", description: "Générateur d'applications et d'environnements de développement." },
    { id: "antigravity", title: "Antigravity", url: "https://antigravity.google/", category: "DEV - OUTILS", description: "IA et outils avancés." },
    { id: "metalama", title: "Metalama", url: "https://www.postsharp.net/metalama", category: "DEV - OUTILS", description: "Génère du code standard C# à la volée lors de la compilation." },
    { id: "verdent", title: "Verdent AI", url: "https://www.verdent.ai/fr", category: "DEV - OUTILS", description: "Solutions IA pour le développement." },
    { id: "ollama", title: "Ollama", url: "https://ollama.com/", category: "DEV - OUTILS", description: "Faire tourner des LLMs localement." },
    { id: "lmstudio", title: "LM Studio", url: "https://lmstudio.ai/", category: "DEV - OUTILS", description: "Télécharger et exécuter des modèles IA en local sur votre PC.", icon: "https://lmstudio.ai/favicon.ico" },
    { id: "pinokio", title: "Pinokio", url: "https://pinokio.computer/", category: "DEV - OUTILS", description: "Installer et lancer des outils IA en un seul clic depuis votre bureau.", icon: "https://pinokio.computer/favicon.ico" },
    { id: "warp", title: "Warp", url: "https://www.warp.dev", category: "DEV - OUTILS", description: "Terminal nouvelle génération avec IA." },
    { id: "mintlify", title: "Mintlify", url: "https://mintlify.com", category: "DEV - OUTILS", description: "Génération de documentation IA." },
    { id: "n8n", title: "n8n", url: "https://n8n.io/", category: "DEV - OUTILS", description: "Outil d'automatisation de flux de travail (workflow) open-source pour développeurs." },
    { id: "beanstalk", title: "Beanstalk", url: "https://beanstalkapp.com", category: "DEV - OUTILS", description: "Un flux de travail complet pour écrire, examiner et déployer du code." },
    { id: "codacy", title: "Codacy", url: "https://www.codacy.com", category: "DEV - OUTILS", description: "Analyses de code automatisées pour de nombreux langages." },
    { id: "codeac", title: "Codeac.io", url: "https://www.codeac.io", category: "DEV - OUTILS", description: "Outil automatisé d'analyse d'infrastructure en tant que code pour DevOps." },
    { id: "codecov", title: "Codecov", url: "https://about.codecov.io", category: "DEV - OUTILS", description: "Outil de couverture de code (SaaS)." },
    { id: "codefactor", title: "CodeFactor", url: "https://www.codefactor.io", category: "DEV - OUTILS", description: "Analyse de code automatisée pour Git." },
    { id: "coderabbit", title: "CodeRabbit", url: "https://coderabbit.ai", category: "DEV - OUTILS", description: "Outil de revue de code basé sur l'IA et intégré à GitHub/GitLab." },
    { id: "codspeed", title: "CodSpeed", url: "https://codspeed.io", category: "DEV - OUTILS", description: "Automatisez le suivi des performances dans vos pipelines CI." },
    { id: "coveralls", title: "Coveralls", url: "https://coveralls.io", category: "DEV - OUTILS", description: "Afficher les rapports de couverture de test." },
    { id: "deepscan", title: "DeepScan", url: "https://deepscan.io", category: "DEV - OUTILS", description: "Analyse statique avancée pour la détection automatique des erreurs JavaScript." },
    { id: "deepsource", title: "DeepSource", url: "https://deepsource.com", category: "DEV - OUTILS", description: "Analyse en continu les modifications du code source." },
    { id: "difftext", title: "DiffText", url: "https://difftext.com", category: "DEV - OUTILS", description: "Trouvez instantanément les différences entre deux blocs de code." },
    { id: "eversql", title: "EverSQL", url: "https://www.eversql.com", category: "DEV - OUTILS", description: "La plateforme nÂ° 1 pour l'optimisation des bases de données SQL." },
    { id: "gerrithub", title: "GerritHub", url: "https://gerrithub.io", category: "DEV - OUTILS", description: "Analyse de code Gerrit gratuite pour les dépôts GitHub." },
    { id: "goreportcard", title: "Go Report Card", url: "https://goreportcard.com", category: "DEV - OUTILS", description: "Qualité du code pour les projets Go." },
    { id: "gtmetrix", title: "GTmetrix", url: "https://gtmetrix.com", category: "DEV - OUTILS", description: "Rapports et recommandations détaillées pour optimiser les sites web." },
    { id: "holistic", title: "Holistic.dev", url: "https://holistic.dev", category: "DEV - OUTILS", description: "Analyseur de code statique pour l'optimisation PostgreSQL." },
    { id: "houndci", title: "HoundCI", url: "https://houndci.com", category: "DEV - OUTILS", description: "Commentaires gratuits sur la qualité du code source pour GitHub." },
    { id: "reviewable", title: "Reviewable", url: "https://reviewable.io", category: "DEV - OUTILS", description: "Analyse de code pour les dépôts GitHub." },
    { id: "coverity", title: "Coverity Scan", url: "https://scan.coverity.com", category: "DEV - OUTILS", description: "Analyse statique de code pour plusieurs langages." },
    { id: "scrutinizer", title: "Scrutinizer", url: "https://scrutinizer-ci.com", category: "DEV - OUTILS", description: "Plateforme d'inspection continue de code." },
    { id: "semanticdiff", title: "SemanticDiff", url: "https://semanticdiff.com", category: "DEV - OUTILS", description: "Comparateur de langages de programmation pour les PR GitHub." },
    { id: "shields", title: "Shields.io", url: "https://shields.io", category: "DEV - OUTILS", description: "Badges de métadonnées de qualité pour les projets open source." },
    { id: "sonarcloud", title: "SonarCloud", url: "https://sonarcloud.io", category: "DEV - OUTILS", description: "Analyse automatisée du code source pour de multiples langages." },
    { id: "github", title: "GitHub", url: "https://github.com", category: "DEV - RESSOURCES", description: "Plateforme collaborative." },
    { id: "mdn", title: "MDN Web Docs", url: "https://developer.mozilla.org", category: "DEV - RESSOURCES", description: "Documentation web de référence." },
    { id: "freefordev", title: "Free For Dev", url: "https://free-for.dev/#/", category: "DEV - RESSOURCES", description: "Annuaire de ressources gratuites." },
    { id: "vercel", title: "Vercel", url: "https://vercel.com", category: "DEV - RESSOURCES", description: "Hébergement ultra-rapide." },
    { id: "radiogarden", title: "Radio Garden", url: "https://radio.garden/?hl=fr", category: "DIVERS", description: "Écoutez des radios du monde entier sur un globe interactif." },
    { id: "pdfmaster", title: "PDF Master", url: "https://pdf-master-v3.vercel.app/", category: "DIVERS", description: "Outils et gestion de fichiers PDF.", icon: "https://pdf-master-v3.vercel.app/favicon.ico" },
    { id: "royout", title: "Royout", url: "https://royout.vercel.app/", category: "DIVERS", description: "Application web diverses.", icon: "https://royout.vercel.app/favicon.ico" },
    { id: "royalscript", title: "Royal Script", url: "https://royal-script-windows.vercel.app/", category: "WINDOWS - UTILITAIRES", description: "Ressources et scripts pour Windows.", icon: "https://royal-script-windows.vercel.app/favicon.ico" },
    { id: "cpasbien", title: "C'est Pas Bien", url: "https://cpasbien.win/", category: "DIVERS", description: "Streaming et téléchargement de films/séries." },
    { id: "filecr", title: "FileCR", url: "https://filecr.com/home/", category: "DIVERS", description: "Téléchargement de logiciels et fichiers." },
    { id: "whitescreen", title: "White Screen", url: "https://www.whitescreen.online/", category: "DIVERS", description: "Écran blanc en ligne, utile pour nettoyer l'écran." },
    { id: "massgrave", title: "MassGrave", url: "https://massgrave.dev/", category: "OFFICES", description: "Activation Windows & Office (Microsoft Activation Scripts)." },
    { id: "malekal", title: "Malekal", url: "https://www.malekal.com/", category: "WINDOWS", description: "Tutoriels Windows, sécurité informatique et logiciels." },
    { id: "openclassrooms", title: "OpenClassrooms", url: "https://openclassrooms.com/fr/", category: "FORMATION - DEV", description: "Plateforme de cours en ligne et formations diplômantes." },
    { id: "cursa", title: "Cursa", url: "https://cursa.app/fr", category: "FORMATION - DEV", description: "Cours gratuits en ligne dans de nombreux domaines." },
    { id: "coursera", title: "Coursera", url: "https://www.coursera.org/", category: "FORMATION - DEV", description: "Formations certifiantes avec les meilleures universités." },
    { id: "mindluster", title: "Mindluster", url: "https://www.mindluster.com/", category: "FORMATION - DEV", description: "Milliers de cours gratuits en ligne." },
    { id: "khanacademy", title: "Khan Academy", url: "https://fr.khanacademy.org/", category: "FORMATION - DEV", description: "Cours gratuits en maths, sciences et bien plus." },
    { id: "udemy", title: "Udemy", url: "https://www.udemy.com/", category: "FORMATION - DEV", description: "Des milliers de cours en ligne (promos fréquentes)." },
    { id: "youtube", title: "YouTube", url: "https://www.youtube.com/", category: "FORMATION - DEV", description: "La plus grande bibliothèque de tutoriels vidéo." },
    { id: "grafikart-cours", title: "Grafikart", url: "https://grafikart.fr/", category: "FORMATION - DEV", description: "Tutoriels développement web et design en français." },
    { id: "loecsen", title: "Loecsen", url: "https://www.loecsen.com/fr", category: "FORMATION - DEV", description: "Apprendre les langues gratuitement avec audio et vocabulaire.", icon: "https://www.loecsen.com/favicon.ico" },
    { id: "googlescholar", title: "Google Scholar", url: "https://scholar.google.com/", category: "FORMATION - DEV", description: "Moteur de recherche d'articles académiques et scientifiques.", icon: "https://scholar.google.com/favicon.ico" },
    { id: "ratatype", title: "Ratatype", url: "https://www.ratatype.com/fr/", category: "FORMATION - DEV", description: "Apprendre à taper au clavier rapidement avec des exercices en ligne.", icon: "https://www.ratatype.com/favicon.ico" },
    { id: "scratch", title: "Scratch", url: "https://scratch.mit.edu/", category: "FORMATION - DEV", description: "Programmer en mode visuel, idéal pour les débutants et enfants (MIT).", icon: "https://scratch.mit.edu/favicon.ico" },
    { id: "codeorg", title: "Code.org", url: "https://code.org/fr", category: "FORMATION - DEV", description: "Apprendre la programmation gratuitement, pour tous les niveaux.", icon: "https://t2.gstatic.com/faviconV2?client=SOCIAL&type=FAVICON&fallback_opts=TYPE,SIZE,URL&url=https://code.org&size=64" },
    { id: "codedex", title: "Codedex", url: "https://www.codedex.io/courses", category: "FORMATION - DEV", description: "Apprendre à coder de façon fun et interactive avec des projets concrets.", icon: "https://t2.gstatic.com/faviconV2?client=SOCIAL&type=FAVICON&fallback_opts=TYPE,SIZE,URL&url=https://www.codedex.io&size=64" },
    { id: "everything", title: "Everything", url: "https://www.voidtools.com/", category: "WINDOWS", description: "Recherche de fichiers ultra-rapide sur Windows." },
    { id: "ninite", title: "Ninite", url: "https://ninite.com/", category: "WINDOWS", description: "Installer plusieurs logiciels Windows d'un seul coup." },
    { id: "sysinternals", title: "Sysinternals", url: "https://learn.microsoft.com/fr-fr/sysinternals/", category: "WINDOWS", description: "Outils avancés Microsoft pour diagnostiquer Windows." },
    { id: "googledocs", title: "Google Docs", url: "https://docs.google.com/", category: "OFFICES", description: "Suite bureautique Google gratuite en ligne." },
    { id: "onlyoffice", title: "OnlyOffice", url: "https://www.onlyoffice.com/fr/", category: "OFFICES", description: "Alternative Open Source à Microsoft Office." },
    { id: "canva", title: "Canva", url: "https://www.canva.com/", category: "OFFICES", description: "Création graphique, présentations et design." },
    { id: "libreoffice", title: "LibreOffice", url: "https://fr.libreoffice.org/", category: "OFFICES", description: "Suite Office 100% gratuite et open source." },
    { id: "ubuntu", title: "Ubuntu", url: "https://ubuntu.com/", category: "LINUX", description: "La distribution Linux la plus populaire." },
    { id: "linuxize", title: "Linuxize", url: "https://linuxize.com/", category: "LINUX", description: "Tutoriels Linux clairs et détaillés." },
    { id: "distrowatch", title: "DistroWatch", url: "https://distrowatch.com/", category: "LINUX", description: "Actualités et classements des distributions Linux." },
    { id: "explainshell", title: "ExplainShell", url: "https://explainshell.com/", category: "LINUX", description: "Explique chaque partie d'une commande bash." },
    { id: "linuxorg", title: "Linux.org", url: "https://www.linux.org/", category: "LINUX", description: "Portail officiel de la communauté Linux." },
    { id: "tails", title: "Tails", url: "https://tails.net/", category: "LINUX", description: "Système Linux portable axé sur la vie privée et l'anonymat.", icon: "https://tails.net/favicon.ico" },
    { id: "parrot", title: "Parrot OS", url: "https://parrotsec.org/", category: "LINUX", description: "Système d'exploitation axé sur la sécurité." },
    { id: "thecodingtrain", title: "The Coding Train", url: "https://thecodingtrain.com/", category: "TUTOS", description: "Coding créatif, fun et accessible." },
    { id: "csstricks", title: "CSS-Tricks", url: "https://css-tricks.com/", category: "TUTOS", description: "Astuces CSS et développement web." },
    { id: "w3schools", title: "W3Schools", url: "https://www.w3schools.com/", category: "TUTOS", description: "Référence interactive pour apprendre le web." },
    { id: "grafikart-tutos", title: "Grafikart Tutos", url: "https://grafikart.fr/tutoriels", category: "TUTOS", description: "Tutoriels dev/design en français." },
    { id: "pcbx", title: "PCBX Community", url: "https://www.pcbx.com/community", category: "TUTOS", description: "Communauté et tutoriels PCBX." },
    { id: "deepl", title: "DeepL", url: "https://www.deepl.com/fr/translator", category: "DIVERS", description: "Le meilleur traducteur en ligne basé sur l'IA." },
    { id: "tempmail", title: "Temp Mail", url: "https://temp-mail.org/fr/", category: "DIVERS", description: "Adresse email temporaire et jetable." },
    { id: "wetransfer", title: "WeTransfer", url: "https://wetransfer.com/", category: "DIVERS", description: "Envoi de gros fichiers simplement." },
    { id: "archive", title: "Archive.org", url: "https://archive.org/", category: "DIVERS", description: "La machine à remonter le temps du web." },
    { id: "pranxhacker", title: "Hacker Typer", url: "https://pranx.com/hacker/simulateur/", category: "DIVERS", description: "Simulateur d'écran de hacker pour impressionner vos amis.", icon: "https://pranx.com/favicon.ico" },
    ...
    { id: "osint4all", title: "OSINT4ALL", url: "https://start.me/p/L1rEYQ/osint4all", category: "CYBERSÉCURITÉ", description: "Boîte à outils OSINT complète pour la recherche et l'investigation en ligne.", icon: "https://start.me/favicon.ico" },
    { id: "fingerprint", title: "Fingerprint.to", url: "https://fingerprint.to/", category: "CYBERSÉCURITÉ", description: "Analyse votre empreinte numérique (navigateur, IP, OS) pour tester votre anonymat.", icon: "https://fingerprint.to/favicon.ico" },
    { id: "osintframework", title: "OSINT Framework", url: "https://osintframework.com/", category: "CYBERSÉCURITÉ", description: "Arbre visuel de tous les outils OSINT classés par catégorie.", icon: "https://osintframework.com/favicon.ico" },
    { id: "fakenamegenerator", title: "Fake Name Generator", url: "https://www.fakenamegenerator.com/", category: "CYBERSÉCURITÉ", description: "Génère des identités fictives complètes (nom, adresse, numéro de téléphone, etc.) pour protéger votre vie privée.", icon: "https://t2.gstatic.com/faviconV2?client=SOCIAL&type=FAVICON&fallback_opts=TYPE,SIZE,URL&url=https://www.fakenamegenerator.com&size=64" },
    ...
    { id: "ankergames", title: "Anker Games", url: "https://ankergames.net/", category: "JEUX - PC", description: "Jeux PC à télécharger." },
    { id: "itchio", title: "Itch.io", url: "https://itch.io/", category: "JEUX - PC", description: "Plateforme de jeux indépendants." },
    { id: "gog", title: "GOG (Good Old Games)", url: "https://www.gog.com/", category: "JEUX - PC", description: "Jeux sans DRM et classiques optimisés." },
    { id: "freeroms", title: "FreeROMS", url: "https://www.freeroms.com/", category: "JEUX - RETRO", description: "ROMs de jeux pour émulateurs." },
    { id: "arcadespace", title: "Arcade Space", url: "https://www.arcadespace.org/home", category: "JEUX - RETRO", description: "Jeux d'arcade classiques." },
    { id: "myabandonware", title: "My Abandonware", url: "https://www.myabandonware.com/", category: "JEUX - RETRO", description: "Téléchargement d'anciens jeux PC classiques." },
    { id: "vimmslair", title: "Vimm's Lair", url: "https://vimm.net/", category: "JEUX - RETRO", description: "ROMs de consoles classiques." },
    { id: "retrogamescc", title: "Retrogames.cc", url: "https://www.retrogames.cc/", category: "JEUX - RETRO", description: "Jouer à des jeux rétro dans le navigateur." },
    { id: "crazygames", title: "CrazyGames", url: "https://www.crazygames.fr/", category: "JEUX - NAVIGATEUR", description: "Catalogue de jeux web gratuits." },
    { id: "poki", title: "Poki", url: "https://poki.com/fr", category: "JEUX - NAVIGATEUR", description: "Jeux web rapides sans installation." },
    { id: "batcave", title: "Batcave", url: "https://batcave.biz/", category: "EBOOK - LITTÉRATURE", description: "Bibliothèque de livres électroniques." },
    { id: "topcartoons", title: "Top Cartoons", url: "https://www.topcartoons.tv/", category: "FILMS - ANIMATION", description: "Dessins animés et séries d'animation." },
    { id: "pwncollege", title: "pwn.college", url: "https://pwn.college/", category: "CYBERSÉCURITÉ", description: "Plateforme d'apprentissage et d'entraînement en cybersécurité." },
    { id: "nimvideo", title: "NIM Video", url: "http://nim.video/", category: "MONTAGE - IA & LIGNE", description: "Outils et ressources de montage vidéo." },
    ...
    { id: "groq", title: "Groq", url: "https://groq.com/", category: "DEV - OUTILS", description: "Moteur d'inférence IA ultra-rapide (LPU) pour les développeurs." },
